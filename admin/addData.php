...
if (isset($_POST["submit"])) {
    ...
    // Panggil metode addPlant() dari objek $plantModel dan teruskan data
    $add = $plantModel->addPlant($data);

    // Cek apakah penambahan tanaman berhasil
    if ($add > 0) {
        echo "
            <script>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="mini-container">
                <div class="add-plant">
                    <h4>PAGE ADD PLANT</h4>
                </div>
                <hr width="100%" height="2px">
                <div class="box">
                    <form action="" method="post">
                        <label class="input-group-text" >nama : <input type="text" placeholder="nama bunga" class="inp" name="name" id="name"></label>
                        ...
                        <label class="input-group-text" >harga : <input type="text" placeholder="harga" class="inp" name="harga" id="harga"></label>
